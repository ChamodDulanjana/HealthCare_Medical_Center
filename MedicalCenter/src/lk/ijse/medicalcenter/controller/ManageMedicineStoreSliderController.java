...
public class ManageMedicineStoreSliderController {
    ...
    public void btnAddMedicineOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Routes.Add_Medicine_Form, paneTwo);
    }

    public void btnSearchMedicineOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Routes.Search_Medicine_Form, paneTwo);
    }

    public void btnUpdateMedicineOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Routes.Update_Medicine_Form, paneTwo);
    }

    public void btnDeleteMedicineOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Routes.Delete_Medicine_Form, paneTwo);
    }

    public void btnViewMedicineDetailOnAction(ActionEvent actionEvent) throws IOException {
        Navigation.navigate(Routes.View_Medicine_Form, paneTwo);
    }
